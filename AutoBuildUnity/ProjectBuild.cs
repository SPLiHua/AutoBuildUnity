...
namespace Skylark.Editor
{
    public class ProjectBuild
    {
        ...
        private static string[] defScene = new string[] { "Assets/Scenes/Main.unity" };
        public static string[] scene
        {
            get
            {
                ...
                foreach (string str in strs)
                {
                    ...
                    {
                        string sceneStr = str.Replace("Scene=", "");
                        return sceneStr.Split(',');
                    }
        ...
        private static string mDefVersion = "0.0.1";
        ...
        {
            Debug.Log("生成AB");
            //AssetBundleExporter.RemoveInvalidAssetBundle();
            AssetBundleExporter.BuildAllAssetBundle();
            Debug.Log("生成ab完成");
            Debug.Log("准备生成APK");
